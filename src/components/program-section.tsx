        ...
        >
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
                ...
                lg:max-w-none lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="relative flex items-center justify-center lg:justify-end">
                        ...
                        <div className="relative">
                            ...
                            {/* SVG OVERLAY - DECORATIVE SHAPES */}
                            <svg
                                className="absolute -top-12 -right-12 w-32 h-32 text-indigo-600 opacity-20 pointer-events-none"
                                fill="currentColor"
                                viewBox="0 0 100 100"
                            >
                            ...
                            <svg
                                className="absolute -bottom-8 -left-8 w-24 h-24 text-indigo-600 opacity-20 pointer-events-none"
                                fill="currentColor"
                                viewBox="0 0 100 100"
                            >
                                <rect x="10" y="10" width="80" height="80" rx="0" />
                            </svg>
                ...
                <div>
                    <Link
                        href='/programs'
                        className='rounded-none w-1/4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 mt-12 flex items-center justify-center mx-auto'>
